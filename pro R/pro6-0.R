...
M <- 1; # mass
R <- 395; # initial radius
e <- 1/3; # eccentricity of the orbit
p <- 266.66; # parameter to do with size of derivatives
...
nr0 <- -950; # cos coefficient term for r
...
legend(-360, 400, legend=c("Numeric", "Analytic"), col=c("black", "green"), lty=1);
...
legend(4, 0.4, legend=c("Radius", "Angle"), col=c("black", "blue"), lty=1);
