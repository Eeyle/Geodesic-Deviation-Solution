...
M <- 1; # mass
R <- 1119.5; # initial radius
e <- 2/100; # eccentricity of the orbit
p <- 1020; # parameter to do with size of derivatives
...
nr0 <- -195; # cos coefficient term for r
...
dqdchi <- function(t, y, parms) {
	...
	e <- 0.02; # global variables dont work
	p <- 1020;
...
y3inter <- approx(t, 2*y3, xout=combinedTime);
...
legend(-1000, 1000, legend=c("Numeric", "Analytic"), col=c("black", "green"), lty=1);
